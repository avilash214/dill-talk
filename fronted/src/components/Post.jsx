    ...
    return (
        <div className="my-8 w-full max-w-sm mx-auto">
            <div className="flex flex-items-center justify-between">
                ...
                <Dialog>
                    ...
                    <DialogContent className="flex flex-col items-center text-sm text-center">
                        ...
                        {
                            bookmarked ? (<Button onClick={bookMarkHandler}  variant="ghost" className="cursor-pointer w-fit  ">
                                Remove from bookmark
                            </Button>) : (
                                <Button variant="ghost" onClick={bookMarkHandler} className="cursor-pointer w-fit  ">
                                    Add to favorites
                                </Button>
                            )
                        }
            ...
            <div className="flex items-center justify-between my-2">
                <div className="flex items-center gap-3">
                    {liked ? (<FaHeart onClick={likeOrDislikeHandler}
                        size={"22px"}
                ...
                {
                    bookmarked ? (
                        <BookmarkCheckIcon onClick={bookMarkHandler} className=" cursor-pointer hover:text-gray-600" />
